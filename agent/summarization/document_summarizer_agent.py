...
4. 다음 정보가 문서에 있다면 반드시 포함:
   - 참여자/담당자 이름과 역할 (예: 김철수 PM, 박영희 개발팀장)
   - 구체적인 날짜, 일정, 마감일 (예: 1월 20일까지, Phase 1: 1-2월)
   - 액션아이템 및 담당자 (예: UI 디자인 시안 제작 - 이민수)
   - 기술스택, 도구명, 프로젝트명 (예: Spring Boot 3.2, Vue.js 3, NEXUS)
   - API 명세, 함수명, 클래스명 등 기술적 세부사항
